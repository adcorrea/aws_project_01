...
public class InvoiceConsumer {
    ...
    private void proccessInvoiceNotification(S3EventNotification s3EventNotification)
        throws IOException{
        ...
        for(S3EventNotification.S3EventNotificationRecord s3EventNotificationRecord : s3EventNotification.getRecords()){
            ...
            String invoiceFile = downloadObjet(bucketName, objectKey);
    ...
    private String downloadObjet(String bucketName, String objectKey) throws IOException {
