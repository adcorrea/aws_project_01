...
public class ProductController {
    ...
    public ResponseEntity<Product> saveProduct(
        ...
        productPublisher.publishProductEvent(productCreated, EventType.PRODUCT_CREATED, "adcorrea");
            ...
            @RequestBody Product product, @PathVariable("id") long id)
    {
        if(productRepository.existsById(id)){
            ...
            productPublisher.publishProductEvent(productUpdated, EventType.PRODUCT_UPDATE, "MASTER");
    ...
    public ResponseEntity<Product> findByCode(@PathVariable("id") long id){
        Optional<Product> optProduct = productRepository.findById(id);
        if(optProduct.isPresent()){
            ...
            productPublisher.publishProductEvent(product, EventType.PRODUCT_DELETED, "denis");
